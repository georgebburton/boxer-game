...
while True:
    ...
    if difficulty == "hard":
        ...
        x = random.randint(1, 3)
        if x == 1:
            print(f"You stand in the corner waiting for the match to start, heart racing. You look at {comp.get_name()} holding his knuckles. Your trainer standing next to you on to the side of the ring. Crowd noise rises to a level you can't hear you're self think, the match is about to start. The ref enters the ring and heads to the middle, calls you and {comp.get_name()} to the center of the ring. the ref then says a few instructions that are mostly muffled out by the noises of the crowd, then you go to fist bump {comp.get_name()} and notice the two of you are similar in strength.")
        elif x == 2:
            print(f"Sweat is dripping down your face the anticipation is so high, the crowd going wild, over the speakers you hear 'welcome to the arena today is a match against {char1.get_name()} in the right corner, and {comp.get_name()} in the left corner', the crowd gets louder, the ref looks at you and tels you to come to the middle of the rink along with {comp.get_name()} to get instructions. while you are there it is so loud you can barely hear the ref. You go for a the beginning fist bump while {comp.get_name()} just sits and stairs menicingly. but you notice under that menicing look he is just as intimidated as you")
        else:
            print(f'You stand in the hall way waiting to enter the arena, your hands shaking in anticipation, mind racing you hear the anouncer blair over the radio, entering on the east side of the arena {char1.get_name()} your trainer trailing behind you while you lightly jog in and hear loud metal over the speakers, and the crowd yelling out your name "{char1.get_name().upper()}, {char1.get_name().upper()}, {char1.get_name().upper()}", you finally feel a sense of normality and calmness unti the music shifts and the anouncer yells over the speakers again, "Entering on the west side of the ring is {comp.get_name().upper()}" The crowd goes wild and seems to shift fully the other way chanting "{comp.get_name().upper()}, {comp.get_name().upper()}, {comp.get_name().upper()}", once everything settles down a little the ref calls you over for the rules and instruction, after he describes the rules you go for the the fist bump and {comp.get_name()} hits you in the face instead and the ref quickly gets inbetween the two of you and asks you if you would still like to go on,')
            proceed = input('would you like to proceed? (yes/no) ')
            if proceed == "yes":
                print("you realized with that hit you may have the strength advantage.")
            else:
                print("you cheaped out of the fight and take the meaningless win, Congrats!")
                break
    elif difficulty == "easy":
        x = random.randint(1, 3)
        if x == 1:
            print(f"You stand in the corner waiting for the match to start, heart racing. You look at {comp.get_name()} holding his knuckles. Your trainer standing next to you on to the side of the ring. Crowd noise rises to a level you can't hear you're self think, the match is about to start. The ref enters the ring and heads to the middle, calls you and {comp.get_name()} to the center of the ring. the ref then says a few instructions that are mostly muffled out by the noises of the crowd, then you go to fist bump {comp.get_name()} and his arms are so week they seem to just fall.")
        elif x == 2:
            print(f"Sweat is dripping down your face the anticipation is so high, the crowd going wild, over the speakers you hear 'welcome to the arena today is a match against {char1.get_name()} in the right corner, and {comp.get_name()} in the left corner', the crowd gets louder, the ref looks at you and tels you to come to the middle of the rink along with {comp.get_name()} to get instructions. while you are there it is so loud you can barely hear the ref. {comp.get_name()} goes for the beginning fist bump while you just sit and stair menicingly.")
        else:
            print(f'You stand in the hall way waiting to enter the arena, your hands shaking in anticipation, mind racing you hear the anouncer blair over the radio, entering on the east side of the arena {char1.get_name()} your trainer trailing behind you while you lightly jog in and hear loud metal over the speakers, and the crowd yelling out your name "{char1.get_name().upper()}, {char1.get_name().upper()}, {char1.get_name().upper()}", you finally feel a sense of normality and calmness unti the music shifts and the anouncer yells over the speakers again, "Entering on the west side of the ring is {comp.get_name().upper()}" The crowd goes wild and seems to shift fully the other way chanting "{comp.get_name().upper()}, {comp.get_name().upper()}, {comp.get_name().upper()}", once everything settles down a little the ref calls you over for the rules and instruction, after he describes the rules you go for the the fist bump and {comp.get_name()} hits your hands and you barely feel it.')
    print(f'\nYou go back to your corner and hear the crowd chearing 3, 2, 1, the ref puts his hand down and yells "FIGHT!" then you walk to the center towards {comp.get_name()}')
